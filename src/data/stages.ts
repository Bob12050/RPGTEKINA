...
export const STAGES: StageDef[] = [
  ...
  stage({
    ...
    postgame: false,
    waves: [
      [{ speciesId: 'puni', level: 2 }, { speciesId: 'rabbit', level: 2 }],
      [{ speciesId: 'mandra', level: 3 }, { speciesId: 'goblin', level: 3 }],
      [{ speciesId: 'ghost', level: 4 }, { speciesId: 'muddoll', level: 4 }],
      [{ speciesId: 'tsunopuni', level: 5 }, { speciesId: 'wolf', level: 5 }],
    ],
  ...
  stage({
    ...
    postgame: false,
    waves: [
      [{ speciesId: 'myconid', level: 8 }, { speciesId: 'wolf', level: 8 }],
      [{ speciesId: 'killerplant', level: 10 }, { speciesId: 'fangwolf', level: 10 }],
      [{ speciesId: 'imp', level: 11 }, { speciesId: 'mandra', level: 11 }],
      [{ speciesId: 'treant', level: 13 }],
    ],
    boss: [{ speciesId: 'dryad', level: 15 }, { speciesId: 'myconid', level: 12 }],
    rewardGold: 150,
